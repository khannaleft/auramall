...
interface CheckoutModalProps {
  isOpen: boolean;
  onClose: () => void;
  onPlaceOrder: (details: { phone: string }) => Promise<void>;
      ...
      case 'success':
        return (
          <div className="p-10 text-center">
            ...
            <p className="text-text-secondary mt-2">You will receive a confirmation email shortly.</p>
          </div>
        );
      case 'failure':
          return (
              <div className="p-10 text-center">
                  ...
                  <p className="text-text-secondary mt-2">Something went wrong with your payment. Please try again.</p>
                  <button
        ...
        return (
          <>
            <div className="overflow-y-auto p-6 flex-grow">
              <h3 className="font-bold text-lg mb-4">Contact & Shipping (mock)</h3>
